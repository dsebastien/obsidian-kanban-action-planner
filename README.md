...
- **Focus on a card's children.** Zoom into a project (card menu or the ▼ children badge) and the board re-filters to just its children, in the usual columns. A dismissible chip next to the filter box shows the focus; zooming again drills down a level.
