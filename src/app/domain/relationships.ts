 ...
 *   point outside the known set (e.g. a task blocked by a project on another
 *   board). Off-board targets are kept; archived blockers are excluded later by
 *   the service layer (issue #13), not here.
 ...
 * are kept even when they leave the known set (a blocker may live on another
 * board); inverse and heuristic relations are only formed between known records.
 *
