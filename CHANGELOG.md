...
* **plugin:** archive every card of a done column from its header ([1c0655d](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/1c0655d713b6fb531d27b94e806a2eb5ae91f65c))
...
* **plugin:** write new cards to the board's column property ([8be5cee](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/8be5ceed66f6fcee3973e279f05995fd25514de3)), closes [#188](https://github.com/dsebastien/obsidian-kanban-action-planner/issues/188)

## [1.28.0](https://github.com/dsebastien/obsidian-kanban-action-planner/compare/1.27.1...1.28.0) (2026-09-11)

### Features

* **plugin:** seed a missing weekly target from the planned blocks ([ab15752](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/ab1575286318b6b8d078da1f3b02f23e2546b031))

## [1.27.1](https://github.com/dsebastien/obsidian-kanban-action-planner/compare/1.27.0...1.27.1) (2026-09-11)

### Bug Fixes

* **plugin:** keep the filter and collapse state per Base view ([a503e3f](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/a503e3f0ffe0e95b143fcb537db91b4a6592c99b))

## [1.27.0](https://github.com/dsebastien/obsidian-kanban-action-planner/compare/1.26.1...1.27.0) (2026-09-11)

### Features

* **plugin:** mirror the Starter Kit's archive configuration ([5cd718d](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/5cd718d57ba19e0927cd5d15baba85ed1f82ce28))

## [1.26.1](https://github.com/dsebastien/obsidian-kanban-action-planner/compare/1.26.0...1.26.1) (2026-09-11)

### Bug Fixes

* **plugin:** refuse an archive move on name collision instead of suffixing ([1f9749e](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/1f9749e74b807d5e180dd1bddd65e9e79ff0ebca))
...
* **plugin:** gate card-height equalization and patch the triage overlay in place ([c2a11f5](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/c2a11f5ad41a19bd6a64d6c6577d395c5336bddf))
* **plugin:** skip the hidden board render during column-triage decisions ([655a5ea](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/655a5eaa5660e54ab8abf552256c2de20ca07730))

## [1.19.1](https://github.com/dsebastien/obsidian-kanban-action-planner/compare/1.19.0...1.19.1) (2026-08-28)

### Bug Fixes

* **plugin:** make Esc reliably exit column triage via a keymap scope ([2fbce95](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/2fbce95069dbb694b16a9170a076bc28d7fd7585))

## [1.19.0](https://github.com/dsebastien/obsidian-kanban-action-planner/compare/1.18.1...1.19.0) (2026-08-28)

### Features

* optimistic column-triage decisions with instant advance and arrow-up step-back ([cfd5d4a](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/cfd5d4ac9798671d3f969c9889262723971dbd54))

## [1.18.1](https://github.com/dsebastien/obsidian-kanban-action-planner/compare/1.18.0...1.18.1) (2026-08-28)

### Bug Fixes

* column-triage drop-zone feedback invisible under Obsidian's unlayered button styles ([7d7467d](https://github.com/dsebastien/obsidian-kanban-action-planner/commit/7d7467d5eb6596fa70888607d4d69889b665c913)), closes [#170](https://github.com/dsebastien/obsidian-kanban-action-planner/issues/170)
